...
class BertEmbeddingsModified(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, history_encoding=None):
        ...
        embeddings = words_embeddings + position_embeddings + token_type_embeddings + history_embeddings
...
class BertModelModified(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, history_encoding=None, attention_mask=None, output_all_encoded_layers=True):
        ...
        embedding_output = self.embeddings(input_ids, token_type_ids, history_encoding)
