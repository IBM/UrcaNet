...
@Model.register("bert_copynet")
class BertCopyNetFTSeq2Seq(Model):
    """
    ...
    def forward(self,  # type: ignore
                bert_input: Dict[str, torch.LongTensor], # for Bert
        ...
        bert_output_dict = self.bert_model(bert_input)
        pooled_output = bert_output_dict['pooled_output']
        passage_representation = bert_output_dict['passage_representation']
