...
@Model.register("bidaf_ft")
class BidirectionalAttentionFlowFT(Model):
    """
    ...
    def forward(self,  # type: ignore
        ...
        modeled_passage_pooled, _ = modeled_passage.max(1)
        # Shape: (batch_size, 4)
        action_logits = self._action_predictor(modeled_passage_pooled)
        ...
        output_dict = {
                ...
                "best_span": best_span,
                "modeled_passage": modeled_passage_pooled
                }
        ...
        if span_start is not None:
            ...
            output_dict['loss'] = span_loss + 6.5 * action_loss
