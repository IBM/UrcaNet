...
@DatasetReader.register("bert_copynet")
class BertCopyNetDatasetReader(DatasetReader):
    """
    ...
    *including* the ``START_SYMBOL`` and ``END_SYMBOL``.
    ...
    def text_to_instance(self,  # type: ignore
        ...
        fields_dict['bert_input'] = TextField(bert_input_tokens, self._bert_token_indexers)
        meta_fields['passage_tokens'] = self._bert_tokenizer.tokenize(passage_text)
